...
function CurveSimulator() {
  ...
  return <Panel className="overflow-hidden">
    ...
    <div className="grid gap-5 p-6 sm:p-7 lg:grid-cols-[minmax(360px,.9fr)_minmax(0,1.1fr)] lg:items-start">
      <div className="rounded-2xl border border-[#e6eaf0] bg-[#f7f8fa] p-4 sm:p-5">
