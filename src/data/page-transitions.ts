  ...
  cards: [
    {
      ...
      tags: [{ text: "iOS 18+", variant: "easing" }, { text: "系统 spring", variant: "spring" }],
      previewId: "ios-page-nav-transition",
      codes: {
        swift: `// SwiftUI — Zoom Navigation Transition (iOS 18+)
...
// 4. dismiss 时自动反转回源位置`,
        uikit: `// UIKit — Zoom Transition (iOS 18+)
...
class ZoomAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    },
    {
      ...
      tags: [{ text: "iOS 14+", variant: "easing" }, { text: ".spring(response:0.35)", variant: "spring" }],
      previewId: "ios-page-matched-geometry",
      codes: {
        swift: `// SwiftUI — matchedGeometryEffect 共享元素过渡
...
// snapshot 保证源 view 不受影响`,
    ...
    {
      title: "fullScreenCover / Sheet",
      tags: [{ text: "~0.5s", variant: "duration" }, { text: "系统 spring", variant: "spring" }],
      previewId: "ios-page-fullscreen",
      codes: {
        swift: `// SwiftUI — fullScreenCover 和 sheet 的系统动画参数
...
.sheet(isPresented: $show) {
    content
        ...
        uikit: `// UIKit — Sheet 和 FullScreen 系统动画参数
